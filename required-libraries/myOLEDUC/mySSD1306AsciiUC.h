...
#include <Arduino.h>
#ifndef mySSD1306AsciiUC_h
#define mySSD1306AsciiUC_h
#include "mySSD1306initUC.h"
#include "myallFontsUC.h"
//------------------------------------------------------------------------------
  ...
  public:
    ...
    */
    ...
    /**
       ...
       @param[in] value The contrast level in the range 0 to 255.
    */
    ...
    */
    ...
    /*
     * these extra functions added by R Brown March 20, 2017
    */
    void InverseCharOn( void );
    void InverseCharOff( void );
    void Display_Normal( void );
    void Display_Inverse( void );
    void Display_Off( void );
    void Display_On( void );
    void Display_Bright( void );
    void Display_Dim( void );
    void Display_Rotate( int m );
...
private:
      ...
      boolean m_invertChar;     // should char be inverted
#if INCLUDE_SCROLLING
