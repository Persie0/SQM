...
void bme280::begin(char i2c_address)
{
...
void bme280::readtrim()
{
  ...
  Wire.requestFrom(_i2c_address, 24);
...
void bme280::getValues(double *temp, double *humid, unsigned long int *pressure)
{
...
void bme280::readData()
{
  ...
  Wire.write(0xF7);
  Wire.endTransmission();
  Wire.requestFrom(bme280::_i2c_address, 8);
  while (Wire.available()) 
  {
    data[i] = Wire.read();
    i++;
